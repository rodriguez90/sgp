...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2019 a las 22:26:46
...
('Cliente', 1, 'Usuario que realiza los pedidos', NULL, NULL, 1556416787, 1556416787),
...
('Proveedor', 1, 'Usuario que provee de los medicamentos a la farmacia', NULL, NULL, 1556416713, 1556496901),
...
(1, 'root', 'root@test.com', '$2y$10$HDLJtYEnkC7Dov8ln3h19eeVAlmR9qkRQwWDNMSwi.W0quRQa0QDa', 'IEXGpe8T6202kKiGrfa6kXGvg3fhagrX', NULL, NULL, 0, 1556204475, NULL, 1556204476, 1556204476, 1557011799, '', 0, 1556204476),
(2, 'proveedor1', 'test@test.cu', '$2y$10$1JRN4hPqY7M6ifoxU.lpWuEOKi8wTWhY7NDgNB.wB2h0qRK3G9M9u', 'kuhhW2jfYkDOijYvCrNMGz0aX2RSTXTq', NULL, '::1', 0, 1556204830, NULL, 1556422591, 1556204830, 1556204847, '', 0, 1556422591),
(8, 'proveedor2', 'test2@test.cu', '$2y$10$roRRT5rPsphHGXWyOdAr3uGccvSguyWZC910nPL7ke.SoCbxDdXIO', 'XpqVdXT24c87psxi0b5MaPEcAK95s3cb', NULL, '::1', 0, 1557011768, NULL, 1557011768, 1557011768, NULL, '', 0, 1557011768),
(13, 'cliente1', 'test1@test.cu', '$2y$10$muqu9gyR1cAN1y.wBWs0i.IRNfp1Qr5bGvuEEYMK7lRTghiTzwC6i', 'EjmNAmHzJO7I3PtsUI5nwa6OFYiZ5S0j', NULL, '::1', 0, 1557021763, NULL, 1557021763, 1557021763, NULL, '', 0, 1557021763),
(15, 'cliente2', 'cliente2@gmail.com', '$2y$10$aqWKQ00uV569ctJoFw0jLenXoCv4pTyVmvYLA5eqrKiDO33FQu1n.', 'xL9rrmMxNl_dMvemOSSLaUO7ZPe-BKn3', NULL, '::1', 0, 1557022960, NULL, 1557022960, 1557022960, NULL, '', 0, 1557022960);
...
--
ALTER TABLE `pedido`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'No.', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `pedido_detalle`
--
ALTER TABLE `pedido_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'No.', AUTO_INCREMENT=49;
